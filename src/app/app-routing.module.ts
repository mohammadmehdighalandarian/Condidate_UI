...
const routes: Routes = [
  ...
  {
    path: 'selectRole/:code', 
    loadChildren: () =>
      import('./components/select-role/select-role.module').then(
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'InvitationList',
        loadChildren: () =>
          import('./components/invitation-list/invitation-list.module').then(
            (m) => m.InvitationListModule,
          ),
      },
      {
        path: 'PublicationRequests',
        loadChildren: () =>
          import('./components/publication-requests/publication-requests.component.module').then(
            (m) => m.PublicationRequestsModule,
          ),
      },
      {
         path: 'RequestList',
         loadChildren: () =>
           import('./components/publication-list/publication-list.module').then(
             (m) => m.PublicationListModule,
           ),
      }
    ],
  },
